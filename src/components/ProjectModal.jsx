...
export default function ProjectModal({ project, onClose, onPrev, onNext, onDelete }) {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${import.meta.env.VITE_API_URL}/projects/${project.slug}`, {
        method: 'PUT',
      ...
      >
        ...
        {editMode ? (
          <form onSubmit={handleUpdate} className="edit-form">
            ...
            {previewImage && <img src={previewImage} alt="Aperçu" className="modal-cover" />}
